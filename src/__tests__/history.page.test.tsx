...
describe('HistoryPage', () => {
  ...
  test('renders list of three history items', () => {
    render(<HistoryPage />);
    expect(screen.getByText('https://swapi.dev/api/people/1/')).toBeInTheDocument();
    expect(screen.getByText('https://swapi.dev/api/people/2/')).toBeInTheDocument();
    expect(screen.getByText('https://swapi.dev/api/people/3/')).toBeInTheDocument();
  });
